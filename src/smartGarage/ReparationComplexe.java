...
public class ReparationComplexe extends Reparation
{
	...
	public ReparationComplexe(String d, String k, ArrayList<Mecanicien> m, int cr, Reparation r) // Plusieurs mécaniciens, sans commentaire, une réparation
	{
		super(d, k, m);
		this.coefReduc = cr;
		this.reparations = new Reparation[100];
	...
	public ReparationComplexe(String d, String k, ArrayList<Mecanicien> m, Commentaire c, int cr, Reparation r) // Plusieurs mécaniciens, avec commentaire, une réparation
	{
		super(d, k, m, c);
		this.coefReduc = cr;
		this.reparations = new Reparation[100];
	...
	public ReparationComplexe(String d, String k, ArrayList<Mecanicien> m, int cr, Reparation[] r) // Plusieurs mécaniciens, sans commentaire, plusieurs réparations
	{
		super(d, k, m);
		this.coefReduc = cr;
		this.reparations = r.clone();
	...
	public ReparationComplexe(String d, String k, ArrayList<Mecanicien> m, Commentaire c, int cr, Reparation[] r) // Plusieurs mécaniciens, avec commentaire, plusieurs réparations
	{
		super(d, k, m, c);
		this.coefReduc = cr;
		this.reparations = r.clone();
